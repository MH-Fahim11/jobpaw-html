    ...
    <div class="preloader">
        ...
        <div class="container mt-5 mb-5">
            <div class=" mb-5">
                ...
                <p>Après avoir rempli le formulaire de 12 sections, vous aurez un CVPaw Pro, qui augmente votre possibilité de trouver un emploi et de booster votre carrière. Toutes les informations fournies sont strictement confidentielles et vous êtes l’unique personne qui en a accès. Les champs avec un astérisque (<span class=" text-danger">*</span>) sont obligatoires.</p>
            </div>
            <form novalidate="" class="">
                <h4>Informations basiques</h4>
                <div class="mb-3 row">
                    <div class="col-md-6 col-12">
                        <label class="form-label" for="Compagnie">Prénom  <span class=" text-danger">*</span>:</label>
                        <input placeholder="Prénom " required="" type="text" id="Compagnie" class="form-control">
                    </div>
                    <div class="col-md-6 col-12">
                        <label class="form-label" for="Sigle">Nom <span class=" text-danger">*</span>:</label>
                ...
                <div class="mb-3 row">
                    <div class="col-md-6 col-12">
                        ...
                        <input placeholder="E-mail" required="" type="email" id="Compagnie" class="form-control">
                ...
                <div class="mb-3 row">
                    <div class="col-md-6 col-12">
                        <label class="form-label" for="Compagnie">Mot de passe <span class=" text-danger">*</span>:</label>
                        <input placeholder="Compagnie" required="" type="password" id="Compagnie" class="form-control">
                    </div>
                    <div class="col-md-6 col-12">
