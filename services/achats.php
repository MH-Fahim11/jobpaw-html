...
<head>
    ...
    <title>Achats || Services Details || JobPaw</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <!-- /.preloader -->
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Achats</h2>
                    ...
                    <div class="col-md-12 col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__thumbnail">
                                <img src="./../assets/images/resources/2.jpg" alt="Achats">
                            </div><!-- /.service-details__thumbnail -->
                            <h3 class="service-details__title">Achats</h3><!-- /.service-details__title -->
