  ...
  <body class="custom-cursor">
    ...
    <div>
      <section class="page-header">
        ...
        <div class="container">
          <h2 class="page-header__title">Mettre publicité sur JobPaw</h2>
          <ul class="hiredots-breadcrumb list-unstyled">
            <li>
              <a href="/">Home</a>
            </li>
            <li>
              <span>Services / Mettre publicité sur JobPaw </span>
            </li>
          </ul>
        </div>
      </section>
    ...
    <div class="my-5">
      <div class="container my-5">
        <div class="mb-5">
          ...
          <table class="table table-striped" id="university-services">
            <thead>
              <tr>
                <th scope="col">#</th>
        ...
        <div class="mb-5">
          ...
          <table class="table table-striped" id="professionals-service">
            <thead>
              <tr>
                <th scope="col">#</th>
        ...
        <div class="mb-5">
          ...
          <table class="table table-striped" id="services-profession">
            <thead>
              <tr>
                <th scope="col">#</th>
      ...
      <div class="mobile-nav__content">
        ...
        <div class="logo-box">
          <a href="index.html" aria-label="logo image"
            ><img
              src="../assets/images/logos/logo-for-dark.png"
              width="155"
              alt=""
          /></a>
        </div>
    ...
    <script src="../scripts/advertise.js"></script>
    <!-- template js -->
