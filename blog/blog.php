                        ...
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                            ...
                            <div class="blog-card__content">
                                ...
                                <ul class="list-unstyled blog-card__meta">
                                    ...
                                    <li><a href="blog-details.php"><i class="fa fa-comments"></i> 2 Comments</a></li>
                                </ul><!-- /.list-unstyled blog-card__meta -->
                                <h3 class="blog-card__title"><a href="blog-details.php">Guide to HR Adviser and Clients Lessening</a></h3><!-- /.blog-card__title -->
                                <p class="blog-card__info">Lorem ipsum is simply free dolor sit amet, consect pisicing elit.</p>
                                <a href="blog-details.php" class="blog-card__link">
                                    Read more
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            ...
                            <div class="blog-card__content">
                                ...
                                <h3 class="blog-card__title"><a href="blog-details.php">Top Skin care tips for oily skins</a></h3><!-- /.blog-card__title -->
                                <p class="blog-card__info">Lorem ipsum is simply free dolor sit amet, consect pisicing elit.</p>
                                <a href="blog-details.php" class="blog-card__link">
                                    Read more
                                    <i class="icon-right-arrow"></i>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            ...
                            <div class="blog-card__content">
                                ...
                                <h3 class="blog-card__title"><a href="blog-details.php">outstanding island for winter sun</a></h3><!-- /.blog-card__title -->
                                <p class="blog-card__info">Lorem ipsum is simply free dolor sit amet, consect pisicing elit.</p>
                                <a href="blog-details.php" class="blog-card__link">
                                    Read more
                                    <i class="icon-right-arrow"></i>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'>
                            ...
                            <div class="blog-card__content">
                                ...
                                <h3 class="blog-card__title"><a href="blog-details.php">My supervisor didn't like the latest</a></h3><!-- /.blog-card__title -->
                                <p class="blog-card__info">Lorem ipsum is simply free dolor sit amet, consect pisicing elit.</p>
                                <a href="blog-details.php" class="blog-card__link">
                                    Read more
                                    <i class="icon-right-arrow"></i>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='400ms'>
                            ...
                            <div class="blog-card__content">
                                ...
                                <h3 class="blog-card__title"><a href="blog-details.php">We need to build it so that it scales</a></h3><!-- /.blog-card__title -->
                                <p class="blog-card__info">Lorem ipsum is simply free dolor sit amet, consect pisicing elit.</p>
                                <a href="blog-details.php" class="blog-card__link">
                                    Read more
                                    <i class="icon-right-arrow"></i>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='500ms'>
                            ...
                            <div class="blog-card__content">
                                ...
                                <h3 class="blog-card__title"><a href="blog-details.php">Big picture organic growth, or fast</a></h3><!-- /.blog-card__title -->
                                <p class="blog-card__info">Lorem ipsum is simply free dolor sit amet, consect pisicing elit.</p>
                                <a href="blog-details.php" class="blog-card__link">
                                    Read more
                                    <i class="icon-right-arrow"></i>
