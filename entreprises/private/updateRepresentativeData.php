...
<body class="custom-cursor">
    ...
    <div class="preloader">
        ...
        <div class="container my-5">
            <h2>Mettre à jour les données du Représentant</h2>
            ...
            <form class="row g-3">
                ...
                <div class="col-md-4">
                    <label for="" class="form-label">Téléphone Achats/Ventes<span class=" text-danger">*</span> :</label>
                    <input type="text" class="form-control" id="">
                </div>
                <div class="col-md-4">
                    <label for="" class="form-label">Téléphone RH<span class=" text-danger">*</span> :</label>
                    <input type="text" class="form-control" id="">
                </div>
                <div class="col-md-4">
