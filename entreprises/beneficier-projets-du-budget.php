...
<body class="custom-cursor">
    ...
    <div>
        <section class="page-header">
            ...
            <div class="container">
                <h2 class="page-header__title">Bénéficier projets du Budget</h2>
                <ul class="hiredots-breadcrumb list-unstyled">
                    <li>
                        <a href="/">Home</a>
                    </li>
                    <li>
                        <span>Professionals / Bénéficier projets du Budget</span>
                    </li>
                </ul>
            </div>
        </section>
    ...
    <div class="my-5">
        <section>
            <div class="container">
                <div>
                    Ce répertoire de données sur les potentialités du pays, les projets du budget, les importations et
                    exportations clés permet aux universités et écoles techniques d’anticiper les besoins en ressources
                    humaines et d’adapter les formations en conséquence. <br><br>

                    Il permet aux entreprises d’orienter leur production et d’adapter leur capacité de production à la
                    demande. <br><br>

                    Vous pourrez leur donner cette opportunité en nous contactant ici et en publiant toute donnée utile
                    à la
                    collectivité dans ce répertoire.
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" style="animation-delay: 100ms;">
                        <div class="feature-one__item text-center">
                            ...
                            <div class="feature-one__item__content">
                                ...
                                <h3 class="feature-one__item__title">Projets du Budget et Opportunités</h3>
                                <p class="feature-one__item__text">.</p>
                                <a href="feature1.html" class="hiredots-btn"><span>Projets du Budget et Opportunités</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" style="animation-delay: 100ms;">
                        <div class="feature-one__item text-center">
                            ...
                            <div class="feature-one__item__content">
                                ...
                                <h3 class="feature-one__item__title">Documents de Projets</h3>
                                <p class="feature-one__item__text">.</p>
                                <a href="feature1.html" class="hiredots-btn"><span>Documents de Projets</span></a>
                            </div>
                        </div>
                    </div>
                </div>
