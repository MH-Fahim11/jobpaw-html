...
<body class="custom-cursor">
    ...
    <div>
        <section class="page-header">
            ...
            <div class="container">
                <h2 class="page-header__title">Trouver formation continue</h2>
                <ul class="hiredots-breadcrumb list-unstyled">
                    <li>
                        <a href="/">Home</a>
                    </li>
                    <li>
                        <span>Professionals / Trouver formation continue</span>
                    </li>
                </ul>
            </div>
        </section>
    ...
    <div class="my-5">
        <section class="">
            <div class="container">
                <div class="mb-5">
                    Ce répertoire des professionnels et des consultants donne une idée des ressources humaines en Haïti
                    et dans la Diaspora.
                    <br /><br />
                    Il sert à l’Etat dans le choix et la mise en œuvre de la politique publique en éducation.
                    <br /><br />
                    Il aide les entreprises et les organisations à recruter en toute discrétion et aussi à élaborer leur
                    plan de recrutement.
                    <br /><br />
                    Il aide les universités/écoles à faire la promotion des diplômés. Vous pourrez ajouter ici votre CV.
                </div>
                ...
                <div class="mt-5">
                    Vous pourrez découvrir ici et utiliser la banque de ressources humaines pour recruter en toute
                    discrétion.
                    <br /> <br />
