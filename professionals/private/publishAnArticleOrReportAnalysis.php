...
<body class="custom-cursor">
    ...
    <div class="preloader">
        ...
        <div class="container my-5">
            <p>En publiant votre article, recherche, analyse, rapport, etc. sur JobPaw, vous <span class=" text-danger">améliorez la chaine formation-production-consommation</span> et donnez une opportunité:</p>
            <ol>
                <li>aux professionnels d'avoir une <span class=" text-danger"> idée de l’application de la recherche aux entreprises et de favoriser la distribution de R&D. </li>
                <li>aux université et écoles techniques <span class=" text-danger">d’adapter leur formation au marché.</span></li>
            </ol>
            <br>
            <h3>Publier un article ou un rapport/analyse/travail de recherche</h3>
