...
<body class="custom-cursor">
    ...
    <div class="preloader">
        ...
        <div class="container mt-5">
            <h2>Bienvenue, Fahim</h2>
            <p>A partir de cette interface, vous pouvez mettre à jour votre profil. Vous découvrirez un univers d’opportunités: <span class=" text-danger">créer CV pro, trouver profession, emploi, stage, séminaire, coaching, statistiques, bourse d’études, etc.</span></p> <br>
            <p>La plateforme vous guide dans vos décisions: <span class=" text-danger">orientation professionnelle, insertion professionnelle, entreprenariat, développement personnel,</span></p>
        </div>
       <div class="my-5">
        <section class="feature-one">
            <div class="container">
                <div class="row gutter-y-30" id="professionals-private-container">
    ...
    <script src="../../assets/js/professionalsPrivate.js"></script>
    <!-- template js -->
