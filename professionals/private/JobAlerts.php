    ...
    <div class="preloader">
        ...
        <div>
            <section class="page-header">
                ...
                <div class="container">
                    <h2 class="page-header__title">Alertes aux offres d’emploi</h2>
                    <ul class="hiredots-breadcrumb list-unstyled">
                        ...
                        <li>
                            <span>Alertes aux offres d’emploi</span>
                        </li>
                    </ul>
                </div>
            </section>
        ...
        <div class="container my-5">
            <h2>Alertes aux offres d’emploi</h2>
            <p>Dans cette section, vous avez l’option de recevoir des alertes par e-mail des nouvelles offres d’emploi, suivant la spécialité choisie</p>
            <p>Les champs avec un astérisque (<span class="text-danger">*</span>) sont obligatoires. Vous verrez les informations après sauvegarde. Vous pouvez les effacer d’abord et les ajouter ensuite.</p>

            <form class="row g-3">
                
                <div class="col-md-6">
                    <label for="" class="form-label">Domaine<span class=" text-danger">*</span> :</label>
                ...
                <div class="col-12">
                    <button class="btn btn-secondary" name="button" type="submit" id="button" value="PHOTO">PHOTO</button>
                    <button class="btn btn-danger" name="button" type="submit" id="button" value="Sauvegarder">Sauvegarder</button>
                    <button class="btn btn-primary" name="button" type="submit" id="button" value="Expériences">CVPAW PDF</button>
                </div>
