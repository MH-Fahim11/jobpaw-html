    ...
    <div class="preloader">
        ...
        <div>
            <section class="page-header">
                ...
                <div class="container">
                    <h2 class="page-header__title">offre(s) d’emploi et stages</h2>
                    <ul class="hiredots-breadcrumb list-unstyled">
                        ...
                        <li>
                            <span>offre(s) d’emploi et stages</span>
                        </li>
                    </ul>
                </div>
            </section>
        ...
        <div class="container my-5 mb-5">
            <h3>Liste : 33 offre(s) d’emploi et stages</h3>
            <p>Ce répertoire des offres d’emplois et des stages offre les opportunités de trouver un emploi et de gérer sa carrière.</p>
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td ><a class=" text-dark" href="">HAS</a></td>
                        <td><a href="">Technicien(ne) en Physiothérapie</a></td>
                        <td><a class=" text-dark" href="">Santé et Professions médicales</a></td>
                        <td><a class=" text-dark" href="">21 Juin 24</a></td>
                    </tr>
                    <tr>
                        <td ><a class=" text-dark" href="">HAS</a></td>
                        <td><a href="">Technicien(ne) en Physiothérapie</a></td>
                    ...
                    <tr>
                        <td colspan="4">Les offres d’emploi de 1 - 33 de 33</td>
                    </tr>
