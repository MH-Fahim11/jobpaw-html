...
<body class="custom-cursor">
    ...
    <div class="preloader">
        ...
        <div>
            <section class="page-header">
                ...
                <div class="container">
                    <h2 class="page-header__title">Research Paper</h2>
                    <ul class="hiredots-breadcrumb list-unstyled">
                        <li>
                            <a href="/">Home</a>
                        </li>
                        <li>
                            <span>Professionals / Research Paper</span>
                        </li>
                    </ul>
                </div>
            </section>
       ...
       <div class="my-5">
        <div class="container">
            <div class="row gutter-y-30 mx-auto blog-slider container my-5" id="research-papers-list">
                <!-- Research paper items will be inserted here by JavaScript -->
            </div>
        </div>
       </div>
       <?php
    ...
    <script src="../assets/js/researchpaper.js"></script>
    <!-- template js -->
